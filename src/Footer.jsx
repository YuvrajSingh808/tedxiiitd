...
export default function Footer() {
    return (
        <div className="mt-28 w-full bg-gradient-to-r from-tedRed">
            <div className="flex w-3/4 mx-auto py-24 justify-between items-center">
                <div className="flex flex-col w-1/3 ">
                    <p className="font-montserrat font-extrabold text-white text-5xl">Get in touch!</p>
                ...
                <div className="flex flex-col w-2/5">
                    <p className="font-montserrat font-extrabold text-white text-5xl my-6">
                        What is TEDx?
                    </p>
                    <p className='text-customWhite text-xl font-montserrat'>
                    ...
                    <p className='text-customWhite text-xl font-montserrat my-6'>This independent TEDx event is operated under license from TED.</p>
                </div>
            </div>
