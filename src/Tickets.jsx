    ...
    return (
        <div className="w-4/5 mt-64 mx-auto z-10" id="tickets">
            <div className="bg-backgroundBlack z-10">
                <p className="font-quattrocento text-tedRed sm:text-8xl text-4xl">Tickets</p>
            </div>
            <div className="mt-20 font-montserrat font-medium sm:text-2xl sm:w-2/3 w-full text-customWhite z-10 bg-backgroundBlack leading-8">
